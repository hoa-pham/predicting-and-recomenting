lines_file = open("association-rule-data/formatted-data.txt", "r")
data_processed_arr = []
...
rules = apriori(data_processed_arr, min_support = 0.09, min_confidence = 0.85, min_lift = 400, max_length = None)
results = list(rules)
